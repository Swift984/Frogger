...
public class Screen extends JPanel implements Runnable , KeyListener
{
	...
	public Screen() throws FontFormatException, IOException
	{
		...
		frog = new Frog(448, 896, 64, 64, FrogIMG, 7);
	...
	public void paint( Graphics window )
	{
		...
		try {
			...
			for(int x = 0; x<frog.getLives()-1;x++)
			{
				for(int liveX = 0; liveX< 192; liveX = liveX + 32)
				{
				window.drawImage(ImageIO.read(live),liveX, 990, 32, 32, null);
				}
			}
